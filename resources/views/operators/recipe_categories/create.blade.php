...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form action="/operator/recipe_category" method="post">
        @csrf
        <div class="form-group">
          <label for="">Category Name : </label>
          <input type="text" name="recipe_category_name" id="recipe_category_name" class="form-control @error('recipe_category_name') is-invalid @enderror" placeholder="Category Name">
