...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form action="/operator/unit/{{ $tables->id }}" method="post">
        @csrf
        @method('PUT')
        <div class="form-group">
          <label for="">Unit Name : </label>
          <input type="text" name="unit_name" id="unit_name" class="form-control @error('unit_name') is-invalid @enderror" placeholder="Unit Name" value="{{ $tables->unit_name }}">
          @error('unit_name')
